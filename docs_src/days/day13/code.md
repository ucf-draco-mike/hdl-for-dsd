---
title: "Day 13 — Code & Notebooks"
---

# :material-download-circle: Day 13 — Code & Notebooks
...
| File | Links |
|------|-------|
| :material-cog: `Makefile` | [:material-github: GitHub](https://github.com/ucf-draco-mike/hdl-for-dsd/blob/main/labs/week4_day13/Makefile){ target=_blank } · [:material-notebook: Open in Jupyter](http://localhost:8888/lab/tree/labs/week4_day13/Makefile){ target=_blank } |
