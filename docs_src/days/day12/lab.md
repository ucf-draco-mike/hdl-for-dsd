...
- :material-file: [`.gitignore`](https://github.com/ucf-draco-mike/hdl-for-dsd/blob/main/labs/week3_day12/ex1_uart_rx/starter/.gitignore){ target=_blank }
...
- :material-file: [`.gitignore`](https://github.com/ucf-draco-mike/hdl-for-dsd/blob/main/labs/week3_day12/ex2_loopback/starter/.gitignore){ target=_blank }
