...
!!! abstract "Starter Code & Notebooks"
    ...
    [:material-notebook: Open Lab Notebook](http://localhost:8888/lab/tree/notebooks/labs/lab_day06.ipynb){ .md-button target=_blank }
    [:material-github: Notebook on GitHub](https://github.com/ucf-draco-mike/hdl-for-dsd/blob/main/notebooks/labs/lab_day06.ipynb){ .md-button target=_blank }
