...
!!! abstract "Starter Code & Notebooks"
    ...
    [:material-notebook: Open in JupyterLab](http://localhost:8888/lab/tree/notebooks/labs/lab_day14.ipynb){ .md-button target=_blank }
    [:material-download: Download .ipynb](../../notebooks/labs/lab_day14.ipynb){ .md-button target=_blank }
    [:material-github: View on GitHub](https://github.com/ucf-draco-mike/hdl-for-dsd/blob/main/notebooks/labs/lab_day14.ipynb){ .md-button target=_blank }
