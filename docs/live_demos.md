...
| `d04_s2` | Blocking vs Nonblocking Side-by-Side | `lecture_examples/week1_day04/d04_s2_ex1/` | `shift_blocking.v`, `shift_nonblocking.v`, `tb_shift_register_demo.v` | `sim`, `wave`, `stat-blocking`, `stat-nonblocking` |
