...
[:material-arrow-left: Back to Barcelona Day Plan](../index.md){ .md-button }
&nbsp;
[:material-book-open-variant: Baseline D4 Materials](../../days/day04/){ .md-button .md-button--primary }

*This overlay supplements the [baseline D4 daily plan](../../days/day04/). All lab exercises and lecture content come from the baseline D4 materials.*
