...
[:material-arrow-left: Back to Barcelona Day Plan](../index.md){ .md-button }
&nbsp;
[:material-book-open-variant: Baseline D7 Materials](../../days/day07/){ .md-button .md-button--primary }

*This overlay supplements the [baseline D7 daily plan](../../days/day07/). All lab exercises and lecture content come from the baseline D7 materials.*
